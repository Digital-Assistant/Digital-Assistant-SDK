...
interface ConfigType {
    ...
    navigatedToNextPage: { check: boolean; url: string };
}
...
export const CONFIG: ConfigType = {
    ...
    RECORDING_SEQUENCE_REDUX: "UDAActiveRecordingDataRedux",
    ...
    set enableNodeTypeSelection(val: boolean) {
        this.enableNodeTypeChangeSelection = val;
        // this.showhtml();
    },
    get enableNodeTypeSelection(): boolean {
